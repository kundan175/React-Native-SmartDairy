...
<Text style={{fontSize:20,color:COLORS.MainHeaderColor,fontWeight:'600',}}>Item</Text>
    ...
    <View style={styles.leftHeaderView}>
      ...
      <Image source = {require('../assets/icons/backArrow.png')}/>
        ...
        <View style={{marginLeft:wp(5)}}>
            {index == 0 ?
        <Text style={styles.headingText}>Sale-Milk</Text>:
        <Text style={styles.headingText}>Sale-Others</Text>
