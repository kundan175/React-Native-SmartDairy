...
<View style={styles.container}>
    ...
    <Text style={styles.text1}>(+880) 111 222 333</Text>
</View>
<CodeField
                            ref={ref}
                            {...props}
...
<TouchableOpacity style={{marginTop:wp(5)}}>
...
cell: {
    ...
    color: 'black',
    height: 60,shadowOpacity:wp(0.1),shadowOffset:{height:1,width:2},borderRadius:wp(10)
},
